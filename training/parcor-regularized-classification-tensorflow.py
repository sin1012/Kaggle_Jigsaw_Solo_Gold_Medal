...
# https://www.kaggle.com/aiaiooas/parcor-regularised-classification?scriptVersionId=36957308
...
def f1():
    return toxic_train_en_dataset().repeat().take(int((NEXAMPLESPEREPOCH-num_nen)/num_dataset_section))
def f2():
    return non_toxic_train_en_dataset().repeat().take(int((NEXAMPLESPEREPOCH-num_nen)/num_dataset_section))
def f3():
    return toxic_train_translated_dataset().repeat().take(int((NEXAMPLESPEREPOCH-num_nen)/num_dataset_section))
def f4():
    return non_toxic_train_translated_dataset().repeat().take(int((NEXAMPLESPEREPOCH-num_nen)/num_dataset_section))
def f5():
...
mass=MaskedBinaryCrossentropy()


# In[72]:


mass(tf.convert_to_tensor([[0.99],
 [0.03125],
 [-1],
 [0.99]]),tf.convert_to_tensor([[0.167218328],
 [0.12330322],
 [0.172422767],
 [0.163807705]]))
...
pre mask loss []
post mask loss [4]
toxic loss [0.986825824 0.986825824 0 0.986825824]
